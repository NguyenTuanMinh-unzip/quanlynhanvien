...
if(isset($_SESSION['username'])) {
  ...
  // Tạo mã khen thưởng mới
  $maKTKL = 'KT' . time() . rand(10, 99);
  ...
  if(isset($_POST['save'])) {
    ...
    if(empty($moTa)) {
      $error['moTa'] = 'Vui lòng nhập mô tả khen thưởng';
    }
    ...
    if(isset($_FILES['hinhAnh']) && $_FILES['hinhAnh']['error'] == 0) {
      ...
      if(!in_array(strtolower($ext), $allowed)) {
        ...
        $newFileName = 'khenthuong_' . time() . '.' . $ext;
        $upload = move_uploaded_file($_FILES['hinhAnh']['tmp_name'], '../uploads/khenthuong/' . $newFileName);
        if($upload) {
          $hinhAnh = $newFileName;
        } else {
    ...
    if(empty($error)) {
      ...
      $insert = "INSERT INTO KTKL(MaKTKL, MaNV, LoaiSuKien, MoTa, HinhAnh, SoTien, NgayApDung, GhiChu) 
                VALUES('$maKTKL', '$maNhanVien', 'Khen thưởng', '$moTa', '$hinhAnh', '$soTien', '$ngayApDung', '$ghiChu')";
      $result = mysqli_query($conn, $insert);
      
      if($result) {
        $showMess = true;
        $success['success'] = 'Thêm khen thưởng thành công!';
        ...
        $error['db'] = 'Lỗi khi thêm khen thưởng: ' . mysqli_error($conn);
      }
    }
  }
?>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="danhsachkhenthuong.php?p=bonus-discipline&a=bonus">Danh sách khen thưởng</a></li>
      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Thêm khen thưởng mới</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <?php 
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Số tiền khen thưởng: <span style="color: red;">*</span></label>
              ...
              <div class="form-group">
                <label>Mô tả khen thưởng: <span style="color: red;">*</span></label>
                <textarea name="moTa" class="form-control" rows="3" placeholder="Nhập mô tả khen thưởng" required><?php echo isset($_POST['moTa']) ? $_POST['moTa'] : ''; ?></textarea>
              ...
              <div class="form-group">
                <button type="submit" name="save" class="btn btn-primary">
                  <i class="fa fa-plus"></i> Thêm khen thưởng
                </button>
                <a href="danhsachkhenthuong.php?p=bonus-discipline&a=bonus" class="btn btn-default">
